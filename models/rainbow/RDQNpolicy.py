...
class RainbowPolicy(QRDQNPolicy):
    """Clase para las redes neuronales de Rainbow DQN, incluye Noisy nets y Dueling networks"""
    ...
    def __init__(
      ...
      linear_kwargs: Dict[str, Any] = {'sigma': 0.5},
...
class RainbowNet(BasePolicy):
    ...
    def __init__(
        ...
        # aun falta implementar noisy nets
        layers_class = nn.Linear if not noisy else NoisyLinear
        ...
        if self.dueling:
            ...
            self.value_net = nn.Sequential(
                ...
                self.activation_fn,
                layers_class(self.net_arch[0], self.action_dim * self.n_quantiles, **self.noisy_kwargs),
            )
    ...
    def forward(self, obs: th.Tensor) -> th.Tensor:
        ...
        if self.dueling:
            value = self.value_net(features).unsqueeze(1)
        ...
        return quantiles.permute(0, 2, 1)
