...
import gym
from sb3_contrib import QRDQN # QRDQN incluye distributional RL
...
from PER import * # clase para incluir Nsteps y PER
...
if __name__ == '__main__':
    ...
    print("initial observation space: ", env.observation_space)
    obs = env.reset()
    print("obs: ", obs.shape)
